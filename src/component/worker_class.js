...
<section class="banner__slider inr-bnr">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-12 city-con">
          <h3 class="text-uppercase">Federal Skilled Worker</h3>
          <h5>Federal Skilled Worker program requirements</h5>
        ...
        <div class="col-lg-6 col-md-12 consultants-img p-0 lmia-img">
          <img class="img-fluid" src="images/worker.jpg"/>
 ...
 <div class="">
         <div class="row">
             <div class="col-md-12">
          <h2 class="text-uppercase">Final Criteria before getting Permanent Residence</h2>
