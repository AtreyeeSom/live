...
<section className="banner__slider">
  ...
  <Slider {...setting}>
    ...
    <div className="slide">
      <div className="slide__img">
        <img src="./images/banner-new.jpg" alt="" data-lazy="./images/banner-new.jpg" className="full-image animated" data-animation-in="zoomOutImage"/>
      </div>
      <div className="slide__content slide__content__right">
        <div className="slide__content--headings ">
  ...
  <div className="social-media-links">
    <ul>
      <li><a href="#"><i class="fa-brands fa-facebook-f change"></i></a></li>
      <li><a href="#"><i class="fa-brands fa-instagram change"></i></a></li>
      <li><a href="#"><i class="fa-brands fa-linkedin-in change"></i></a></li>
      <li><a href="#"><i class="fa-brands fa-youtube change"></i></a></li>
