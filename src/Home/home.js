  ...
  return (
    <div> <header>
          ...
          <div className="nav-wrapper">
            <nav className="navbar">
              ...
              <div className="dropdown-menu">
                ...
                <li className="nav-item"><a href="#">sponsor</a></li>
                <li className="nav-item"><a href="#">BUSINESS </a></li>
                <li className="nav-item"><a href="#">PNP</a></li>
      ...
      <section className="banner__slider">
                ...
                <div className="slide" key={index}>
                  ...
                  <div className="slide__content slide__content__right ">
                    <div className="slide__content--headings ">
                      <article>
                        <Animated animationIn="w3-container w3-center w3-animate-left  animated top-title tess" isVisible={true} className="animated top-title tess" data-delay-in="0.8">Immigration</Animated>
                      </article>
                      <h2><Animated animationIn="fadeInUp" isVisible={true} className="animated text-uppercase temm">Consulting{value}</Animated></h2>
                      <h3><Animated animationIn="fadeInUp" isVisible={true} className="animated text-uppercase temm">Business{value}</Animated></h3>
                      <p><Animated animationIn="fadeInUp" isVisible={true} className="animated text-uppercase temm">Aenean imperdiet. Etiam ultricies nisi
        ...
        {/* <div class='container-fluid' >   
          <OwlCarousel items={3} margin={8} autoplay ={true} >  
        <div ><img  className="full-image animated" src= {'./images/banner-new.jpg'}/></div>  
           <div><img  className="full-image animated" src= {'./images/banner-new.jpg'}/></div>   */}
        {/* <div><img  className="full-image animated" src= {'assets/img/img4.jpg'}/></div>  
           <div><img  className="full-image animated" src= {'assets/img/img3.jpg'}/></div>  
           <div><img className="full-image animated" src= {'assets/img/img5.jpg'}/></div>  
           <div><img className="full-image animated" src= {'assets/img/img6.jpg'}/></div>  
           <div><img className="full-image animated" src= {'assets/img/img7.jpg'}/></div>   */}
        {/* </OwlCarousel>  
      </div>   */}
      </section>
      ...
      <section className="video-area">
        <div className="container-fluid">
          <div className="row video-slider text-center">
            <Slider {...setting}>
              <div className="col-md-8 mx-auto">
                <img src="images/video.jpg" className="img-fluid w-200 " />
